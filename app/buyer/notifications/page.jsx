            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                <div>
                    <div className="flex items-center gap-3">
                        <h1 className="text-4xl font-black text-slate-900 leading-tight">My <span className="text-[#05DF72]">Alerts</span></h1>
                        {unreadCount > 0 && (
                    ...
                    <p className="text-slate-400 font-bold text-sm mt-1">Order updates, reschedule requests, and system notifications.</p>
                </div>
                {unreadCount > 0 && (
                    <button 
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center justify-between gap-4 mb-1.5">
                                        <div className="flex items-center gap-2 min-w-0">
                                            ...
                                            <h3 className={`font-black uppercase tracking-tight text-sm truncate ${notif.status === 'unread' ? 'text-slate-900' : 'text-slate-500'}`}>
                                                {notif.title}
                                            </h3>
                                        </div>
