 ...
 * /payment/callback
 *
 * Flutterwave redirects here after the hosted checkout is completed.
 * Query params: status, tx_ref, transaction_id
 *
 * We verify the transaction on the server, then redirect the user.
 */
export default function PaymentCallbackPage() {
    ...
    useEffect(() => {
        const verify = async () => {
            // If Flutterwave says payment was cancelled or failed, don't bother verifying
            ...
            try {
                ...
                if (data.success) {
                    ...
                    // Redirect to buyer dashboard after 2.5s
