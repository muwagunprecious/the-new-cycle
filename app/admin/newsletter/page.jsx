        ...
        <div className="p-6 lg:p-10 max-w-6xl mx-auto space-y-8">
            <div className="flex items-end justify-between gap-4">
                ...
                <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-2 px-5 py-3 bg-white border border-slate-200 rounded-sm text-sm font-bold text-slate-600 hover:bg-slate-50 transition-all disabled:opacity-50 shadow-sm"
                >
            ...
            <div className="bg-slate-900 rounded-sm p-6 text-white max-w-sm relative overflow-hidden shadow-md border border-slate-700">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#05DF72]/10 rounded-sm blur-2xl"></div>
                <div className="relative z-10 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-sm bg-[#05DF72]/10 border border-[#05DF72]/20 flex items-center justify-center shrink-0">
                                ...
                                <tr key={sub.id} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="p-6 pl-8">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-sm bg-slate-100 flex items-center justify-center shrink-0 border border-slate-200">
                                    ...
                                    <td className="p-6">
                                        <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-sm text-[10px] font-black uppercase tracking-wide border ${
                                            sub.status === 'active' 
