...
// Testing with "GOCYCLE " (with the trailing space as seen in diagnostic)
const SENDER_ID = "GOCYCLE "; 
const BASE_URL = "https://api.ng.termii.com";

async function testSendTokenWithGocycle() {
    const url = `${BASE_URL}/api/sms/otp/send`;
    console.log(`Sending Token to ${PHONE} using Termii API (${url}) with sender "GOCYCLE "...`);
